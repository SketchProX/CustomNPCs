...
namespace XPocketMC\CustomNPCs\Form\Settings;

use XPocketMC\CustomNPCs\{Entity\CustomNPCs, Form\formapi\FormAPI, Form\SettingsManager, NPC};
...
class SkinAndCape
{
     ...
     * @return void
     */
    public function removeCapeTag (CustomNPCs $NPC) {
     ...
     * @return Skin
     */
    public function getSkin (CustomNPCs $NPC, string $cape = null): Skin {
